import 'dart:async';
import '../chat/subWidgets/common_widgets.dart';
import '../chat/subWidgets/local_notification_view.dart';
              ...
              ListView(
                ...
                //  if (userData['userId'] == widget.myID) {
                 ...
                 if (false) {
                   ...
                   print("firebase_doc"+widget.myID);

                    return StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance
                        .collection('users/j95lAJsNoahWJ1BIBb1caNsCxOZ2/chatlist')
                        .snapshots(),
