...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  await g.firebase_init(g.active_key,g.cmd);
...
class _MyHomePageState extends State<MyHomePage> with FBAuth{
  ...
  void _updateFBdata(String _userId){
    ...
    //   });
    // }else{
      FBCloudStore.instanace.saveUserDataToFirebaseDatabase(_emailTextController.text,_userId,_nameTextController.text,_introTextController.text,"https://preloved.com/img/u.png").then((userData){
        _moveToChatList(userData);
      });
   // }
  }
