...
class pdfviewParser extends WidgetParser {

  final List<String> dtag;
  pdfviewParser(this.dtag);
  ...
  Widget parse(Map<String, dynamic> m, BuildContext buildContext,
    ...
    return pdfview_ex(buildContext,m);
  ...
  @override
  String get widgetName => "PDFView";
}


class pdfview_ex extends StatefulWidget {

  final BuildContext _buildContext;
  final  Map<String, dynamic> m;

  TextEditingController txtc =  TextEditingController();
  pdfview_ex( this._buildContext, this.m);
  ...
  @override
  _pdfview_exState createState() => _pdfview_exState(m);

}

class _pdfview_exState  extends State<pdfview_ex> {

  final  Map<String, dynamic> m;
  final Completer<PDFViewController> _controller =
  Completer<PDFViewController>();

  _pdfview_exState(this.m);
