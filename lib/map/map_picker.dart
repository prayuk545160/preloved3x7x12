...
void main() async {
  ...
  runApp(MaterialApp(
    ...
    home: SafeArea(child: map_picker()),
  ));
}

class map_picker extends StatefulWidget {
  @override
  _map_pickerState createState() => _map_pickerState();
}

class _map_pickerState extends State<map_picker> {
