...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: getplace_autocomplate(),
    );
  }
}

class getplace_autocomplate extends StatefulWidget {
  @override
  _getplace_autocomplateState createState() => _getplace_autocomplateState();
}

class _getplace_autocomplateState extends State<getplace_autocomplate> {
  ...
  void initState() {
   ...
   // gmapplace = GoogleMapsPlaces(apiKey: g.get_googlemap_apikey());
  ...
  void autoCompleteSearch(String value) async {
    var result = await googlePlace.autocomplete.get(value,language:"th");
